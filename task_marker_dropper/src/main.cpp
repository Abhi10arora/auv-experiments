...
void markerDataCallback(const geometry_msgs::PointStampedPtr &_msg) {
    if (count_marker == 0) {
...
int main(int argc, char **argv) {
    ros::init(argc, argv, "task_marker_dropper");
    ros::NodeHandle nh;
    ros::Subscriber markerDataListener = nh.subscribe("/marker_task/marker_coordinates", 1000, &markerDataCallback);
